...
1. Download the `/plugins/whisparr-bridge/` folder to your Stash plugins directory
2. Reload plugins in Stash (Settings → Plugins → Reload)
3. Configure the plugin settings (Settings → Plugins → Whisparr Bridge)
...
Configure both the URL and API Key in Settings → Plugins → Whisparr Bridge.
